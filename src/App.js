    ...
    <div className="App">
      ...
      <div className='showPanel'>
        ...
        <div className='btbar'>
          ...
          <div className={active.io ? 'btn on' : 'btn'} id='io' onClick={onClick} ><img src='https://cdn-icons-png.flaticon.com/512/1076/1076745.png' alt='Info' onClick={onImgClick}/></div>
        </div>
        {pannel}
      </div>
    </div>
